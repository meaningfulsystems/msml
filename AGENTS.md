...
- Sourced numbers only (USB RF, HGA, LM steerable, CM ECS, LM-5, A7L/PLSS, food plan, A11 PK p.109 tank loads and launch masses, engine thrusts cited from both PK and TNs when they conflict, Block II AGC AGCIS 30, A11 ropes Comanche 055 / LMY99 rev 001, AEA 4096×18-bit, CM RCS 93 lbf, electrical topology). Mark UNKNOWN: RTCC MOC vs DSC on A11, 4th AIS ship, A11 food intake, entry blackout duration, official CSM lunar Δv table, CSM-107 SPS loaded lb, A11 AGS flight-program name, SM RCS per-engine thrust. Do not invent those. Do not use 100 lbf for SM RCS unless cited.
