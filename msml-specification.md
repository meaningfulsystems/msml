...
- `projects/apollo` — in-progress public NASA Apollo 11 / Block II instance on the generic Saturn V + CSM + LM stack. Namespace `Apollo`. File stem `apollo`. Other missions are notes only.
