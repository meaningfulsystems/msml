...
```json
{
  ...
  "type": "transition",
  "source": "Toaster.STM.Toasting",
  "target": "Toaster.STM.Done",
...
```bash
python3 render_msml.py path/to/diagram.msmd
python3 render_all.py projects/humanity-optimization
```

`render_all.py` searches for `.msmd` files only.
