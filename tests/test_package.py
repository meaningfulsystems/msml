...
class PackageApiTests(unittest.TestCase):
    ...
    def test_architecture_design_notes(self):
        ...
        self.assertNotIn("Andrew Fried", apollo)
        self.assertNotIn("technical authority", apollo)
        self.assertNotIn("AI team under", apollo)
        ...
        self.assertIn("1,050–6,800", apollo)
        self.assertNotIn("10:1–6,800", apollo)
        self.assertIn("ST-124", apollo)
        self.assertNotIn("LMA790", apollo.split("## References", 1)[-1])
