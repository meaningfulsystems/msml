...
class ApolloExampleTests(unittest.TestCase):
    ...
    def test_public_architecture_full_model(self) -> None:
        ...
        self.assertIn("A11-FP 2:44:26", tli_do)
        ...
        self.assertIn("075:49:49.65", loi_do)
        self.assertNotIn("075:49:50", loi_do)
    ...
    def test_does_not_collapse_required_computers(self) -> None:
        ...
        self.assertIn("75:54:28 GET A11-FP planned", get_note)
        self.assertIn("do not cite Press Kit as the LOI-1 source", get_note)
        self.assertIn("075:49:49.65", get_note)
        self.assertNotIn("075:49:50", get_note)
        self.assertIn("PK planned 02:44:15", get_note)
        self.assertIn("A11-FP 2:44:26", get_note)
