...
- In-progress Apollo 11 / Block II example at `projects/apollo/` (generic Saturn V + CSM + LM stack; public NASA architecture; 7 / 8 / 10 / 13 called out in notes only; refine when the research brief arrives).
