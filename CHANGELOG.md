...
- Full Apollo 11 / Block II system + subsystem example at `projects/apollo/` (AS-506; generic Saturn V + CSM + LM stack; public NASA architecture; 7 / 8 / 10 / 13 called out in notes only), including the ground/crew/USB slice and the vehicles/AGC slice (separate S-IC/S-II/S-IVB/IU/SLA/LES/CM/SM/descent/ascent; two AGCs; AGS; IU LVDC; EMS; sourced thrusts and A11 PK masses; tank loads, Δv, rope IDs, and AGS memory marked UNKNOWN).
