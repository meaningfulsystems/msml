...
**Use cases.** Associations from actors to use cases. `include` source is the including use case. E-bike: Ride «include» Adjust Assist (not the reverse). Rider on ride/adjust; Charger on Charge Bike. Do not keep `lockBikeUseCase`.
