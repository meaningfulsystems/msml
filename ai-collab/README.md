# Archive — pre-v1.0 collaboration notes

This folder is **historical**. It holds 2026-05 design reviews and session logs from the model/diagram split.

The living agent path is:
